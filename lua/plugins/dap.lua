...
local function toggle_debug_ui(dapui, name_to_layout, name)
  dapui.close()
...
return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>dr", function() toggle_debug_ui(dapui, name_to_layout, "repl") end,
        { desc = "Debug: toggle repl ui" })
      vim.keymap.set("n", "<leader>ds", function() toggle_debug_ui(dapui, name_to_layout, "stacks") end,
        { desc = "Debug: toggle stacks ui" })
      vim.keymap.set("n", "<leader>dw", function() toggle_debug_ui(dapui, name_to_layout, "watches") end,
        { desc = "Debug: toggle watches ui" })
      vim.keymap.set("n", "<leader>db", function() toggle_debug_ui(dapui, name_to_layout, "breakpoints") end,
        { desc = "Debug: toggle breakpoints ui" })
      vim.keymap.set("n", "<leader>dS", function() toggle_debug_ui(dapui, name_to_layout, "scopes") end,
        { desc = "Debug: toggle scopes ui" })
      vim.keymap.set("n", "<leader>dc", function() toggle_debug_ui(dapui, name_to_layout, "console") end,
      ...
      dap.listeners.after.event_output.dapui_config = function(_, body)
        if body.category == "console" then
          -- Sends stdout/stderr to Console
